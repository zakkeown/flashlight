...
class TransformerEncoderLayer(Module):
    ...
    Example:
        ...
        >>> src = mlx_compat.randn(32, 10, 512)  # (batch, seq, feature)
...
class TransformerDecoderLayer(Module):
    ...
    Example:
        ...
        >>> memory = mlx_compat.randn(32, 20, 512)  # encoder output
        >>> tgt = mlx_compat.randn(32, 10, 512)     # decoder input
...
class TransformerEncoder(Module):
    ...
    Example:
        ...
        >>> src = mlx_compat.randn(32, 10, 512)
        >>> out = encoder(src)
        >>> out.shape
        (32, 10, 512)
    """
...
class TransformerDecoder(Module):
    ...
    Example:
        ...
        >>> memory = mlx_compat.randn(32, 20, 512)  # encoder output
        >>> tgt = mlx_compat.randn(32, 10, 512)
...
class Transformer(Module):
    ...
    Example:
        ...
        >>> src = mlx_compat.randn(32, 10, 512)
        >>> tgt = mlx_compat.randn(32, 20, 512)
