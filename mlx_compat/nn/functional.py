...
re-exporting from mlx_compat.ops and adding new functional implementations.
"""
...
def cosine_similarity(
    ...
    Example:
        >>> x1 = mlx_compat.randn(10, 128)
        >>> x2 = mlx_compat.randn(10, 128)
...
def cdist(
    ...
    Example:
        >>> x1 = mlx_compat.randn(10, 128)  # 10 vectors of dim 128
        >>> x2 = mlx_compat.randn(20, 128)  # 20 vectors of dim 128
        >>> dist = F.cdist(x1, x2)
        >>> dist.shape
        (10, 20)
    """
...
# Module re-exports
from . import grad
torch = None  # Placeholder - user should import mlx_compat instead
...
def has_torch_function(*args) -> bool:
    ...
    In mlx_compat, we don't use torch function dispatch, so this always returns False.
    """
    return False
...
def handle_torch_function(public_api, relevant_args, *args, **kwargs):
    ...
    In mlx_compat, this just calls the public API directly since we don't
