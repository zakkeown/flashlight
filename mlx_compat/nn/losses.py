...
class MSELoss(Module):
    ...
    Example:
        ...
        >>> x = mlx_compat.randn(3, 5, requires_grad=True)
        >>> y = mlx_compat.randn(3, 5)
        >>> loss = criterion(x, y)
        >>> loss.backward()
    """
...
class NLLLoss(Module):
    ...
    Example:
        ...
        >>> log_probs = mlx_compat.randn(3, 5, requires_grad=True)
        >>> target = mlx_compat.tensor([1, 0, 4], dtype=mlx_compat.int32)
...
class CrossEntropyLoss(Module):
    ...
    Example:
        ...
        >>> logits = mlx_compat.randn(3, 5, requires_grad=True)
        >>> target = mlx_compat.tensor([1, 0, 4], dtype=mlx_compat.int32)
...
class BCELoss(Module):
    ...
    Example:
        ...
        >>> x = mlx_compat.sigmoid(mlx_compat.randn(3, requires_grad=True))
        >>> y = mlx_compat.tensor([1.0, 0.0, 1.0])
        >>> loss = criterion(x, y)
    """
...
class BCEWithLogitsLoss(Module):
    ...
    Example:
        ...
        >>> x = mlx_compat.randn(3, requires_grad=True)
        >>> y = mlx_compat.tensor([1.0, 0.0, 1.0])
        >>> loss = criterion(x, y)
    """
