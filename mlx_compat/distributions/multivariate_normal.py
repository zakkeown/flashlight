...
class LowRankMultivariateNormal(Distribution):
    ...
    def covariance_matrix(self) -> Tensor:
        return Tensor(mx.matmul(self.cov_factor, mx.swapaxes(self.cov_factor, -2, -1)) +
    ...
    def sample(self, sample_shape: Tuple[int, ...] = ()) -> Tensor:
        ...
        result = self.loc + mx.squeeze(mx.matmul(self.cov_factor, mx.expand_dims(eps_factor, -1)), -1) + mx.sqrt(self.cov_diag) * eps
        return Tensor(result)
