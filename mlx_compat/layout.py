...
class nhwc_mode:
    ...
    Example:
        ...
        ...     mlx_compat.nn.Conv2d(3, 64, 3),
        ...     mlx_compat.nn.BatchNorm2d(64),
        ...     mlx_compat.nn.ReLU(),
        ...     mlx_compat.nn.MaxPool2d(2),
        ... )
        >>> with mlx_compat.nhwc_mode():
