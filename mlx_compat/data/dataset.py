...
class ConcatDataset(Dataset[T_co]):
    ...
    Example:
        >>> dataset1 = TensorDataset(mlx_compat.randn(10, 5))
        >>> dataset2 = TensorDataset(mlx_compat.randn(20, 5))
...
class Subset(Dataset[T_co]):
    ...
    Example:
        >>> dataset = TensorDataset(mlx_compat.arange(100))
...
class StackDataset(Dataset[Tuple[Any, ...]]):
    ...
    Example:
        >>> ds1 = TensorDataset(mlx_compat.randn(10, 5))
        >>> ds2 = TensorDataset(mlx_compat.randn(10, 3))
