...
class TestLinear(TestCase):
    ...
    def test_creation(self):
        ...
        linear = mlx_compat.nn.Linear(in_features=64, out_features=128)
    ...
    def test_creation_with_bias(self):
        ...
        linear = mlx_compat.nn.Linear(64, 128, bias=True)
    ...
    def test_creation_without_bias(self):
        ...
        linear = mlx_compat.nn.Linear(64, 128, bias=False)
        self.assertIsNone(linear.bias)

    def test_forward_2d(self):
        """Test Linear forward pass with 2D input."""
        linear = mlx_compat.nn.Linear(64, 128)
        x = mlx_compat.randn(4, 64)  # batch, features
        output = linear(x)
    ...
    def test_forward_3d(self):
        ...
        linear = mlx_compat.nn.Linear(64, 128)
        x = mlx_compat.randn(4, 10, 64)  # batch, seq, features
        output = linear(x)
    ...
    def test_parity_with_pytorch(self):
        ...
        # MLX
        linear_mlx = mlx_compat.nn.Linear(in_features, out_features)
        linear_mlx.weight._mlx_array = mlx_compat.tensor(weight_np)._mlx_array
        linear_mlx.bias._mlx_array = mlx_compat.tensor(bias_np)._mlx_array

        out_torch = linear_torch(torch.tensor(x_np))
        out_mlx = linear_mlx(mlx_compat.tensor(x_np))
...
class TestBilinear(TestCase):
    ...
    def test_creation(self):
        ...
        bilinear = mlx_compat.nn.Bilinear(in1_features=32, in2_features=64, out_features=128)
    ...
    def test_creation_with_bias(self):
        ...
        bilinear = mlx_compat.nn.Bilinear(32, 64, 128, bias=True)
        self.assertIsNotNone(bilinear.bias)

    def test_creation_without_bias(self):
        """Test Bilinear creation without bias."""
        bilinear = mlx_compat.nn.Bilinear(32, 64, 128, bias=False)
        self.assertIsNone(bilinear.bias)

    def test_forward_shape(self):
        """Test Bilinear forward pass."""
        bilinear = mlx_compat.nn.Bilinear(32, 64, 128)
        x1 = mlx_compat.randn(4, 32)
        x2 = mlx_compat.randn(4, 64)
    ...
    def test_forward_3d(self):
        ...
        bilinear = mlx_compat.nn.Bilinear(32, 64, 128)
        x1 = mlx_compat.randn(4, 10, 32)
        x2 = mlx_compat.randn(4, 10, 64)
        output = bilinear(x1, x2)
        self.assertEqual(output.shape, (4, 10, 128))
    ...
    def test_parity_with_pytorch(self):
        ...
        # MLX
        bilinear_mlx = mlx_compat.nn.Bilinear(in1, in2, out)
        # Copy weights
        bilinear_mlx.weight._mlx_array = mlx_compat.tensor(
            bilinear_torch.weight.detach().numpy()
        )._mlx_array
        bilinear_mlx.bias._mlx_array = mlx_compat.tensor(
            bilinear_torch.bias.detach().numpy()
        )._mlx_array

        out_torch = bilinear_torch(torch.tensor(x1_np), torch.tensor(x2_np))
        out_mlx = bilinear_mlx(mlx_compat.tensor(x1_np), mlx_compat.tensor(x2_np))
