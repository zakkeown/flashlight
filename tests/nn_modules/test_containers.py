...
class TestSequential(TestCase):
    ...
    def test_creation_from_modules(self):
        ...
        seq = flashlight.nn.Sequential(
            flashlight.nn.Linear(10, 20), flashlight.nn.ReLU(), flashlight.nn.Linear(20, 5)
        )
    ...
    def test_parameters(self):
        ...
        seq = flashlight.nn.Sequential(flashlight.nn.Linear(10, 20), flashlight.nn.Linear(20, 5))
...
class TestModuleList(TestCase):
    ...
    def test_creation(self):
        ...
        modules = flashlight.nn.ModuleList(
            [flashlight.nn.Linear(10, 20), flashlight.nn.Linear(20, 30)]
        )
    ...
    def test_parameters(self):
        ...
        modules = flashlight.nn.ModuleList(
            [flashlight.nn.Linear(10, 20), flashlight.nn.Linear(20, 5)]
        )
...
class TestModuleDict(TestCase):
    ...
    def test_creation(self):
        ...
        modules = flashlight.nn.ModuleDict(
            {"linear1": flashlight.nn.Linear(10, 20), "linear2": flashlight.nn.Linear(20, 30)}
        )
        self.assertEqual(len(modules), 2)
    ...
    def test_keys_values_items(self):
        ...
        modules = flashlight.nn.ModuleDict(
            {"a": flashlight.nn.Linear(10, 20), "b": flashlight.nn.Linear(20, 30)}
        )
