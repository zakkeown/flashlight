    ...
    for i, grad_np in enumerate(grads):
        ...
        try:
            np.testing.assert_allclose(
                mlx_val, torch_val, rtol=rtol, atol=atol, err_msg=f"Mismatch at step {i+1}"
            )
...
class TestSGDParity(TestCase):
    ...
    def test_sgd_basic(self):
        ...
        run_optimizer_parity_test(self, optim.SGD, torch_optim.SGD, {"lr": 0.01})

    def test_sgd_momentum(self):
        """Test SGD with momentum."""
        run_optimizer_parity_test(self, optim.SGD, torch_optim.SGD, {"lr": 0.01, "momentum": 0.9})

    def test_sgd_nesterov(self):
        """Test SGD with Nesterov momentum."""
        run_optimizer_parity_test(
            self, optim.SGD, torch_optim.SGD, {"lr": 0.01, "momentum": 0.9, "nesterov": True}
        )

    def test_sgd_weight_decay(self):
        """Test SGD with weight decay."""
        run_optimizer_parity_test(
            self, optim.SGD, torch_optim.SGD, {"lr": 0.01, "weight_decay": 0.01}
        )

    def test_sgd_momentum_weight_decay(self):
        """Test SGD with momentum and weight decay."""
        run_optimizer_parity_test(
            self, optim.SGD, torch_optim.SGD, {"lr": 0.01, "momentum": 0.9, "weight_decay": 0.01}
        )

    def test_sgd_dampening(self):
        """Test SGD with dampening."""
        run_optimizer_parity_test(
            self, optim.SGD, torch_optim.SGD, {"lr": 0.01, "momentum": 0.9, "dampening": 0.1}
        )
...
class TestAdamParity(TestCase):
    ...
    def test_adam_basic(self):
        """Test basic Adam."""
        run_optimizer_parity_test(self, optim.Adam, torch_optim.Adam, {"lr": 0.001})

    def test_adam_custom_betas(self):
        """Test Adam with custom beta values."""
        run_optimizer_parity_test(
            self, optim.Adam, torch_optim.Adam, {"lr": 0.001, "betas": (0.85, 0.995)}
        )

    def test_adam_weight_decay(self):
        """Test Adam with weight decay (L2 regularization)."""
        run_optimizer_parity_test(
            self, optim.Adam, torch_optim.Adam, {"lr": 0.001, "weight_decay": 0.01}
        )

    def test_adam_amsgrad(self):
        """Test Adam with AMSGrad variant."""
        run_optimizer_parity_test(
            self, optim.Adam, torch_optim.Adam, {"lr": 0.001, "amsgrad": True}
        )

    def test_adam_amsgrad_weight_decay(self):
        """Test Adam with AMSGrad and weight decay."""
        run_optimizer_parity_test(
            self, optim.Adam, torch_optim.Adam, {"lr": 0.001, "amsgrad": True, "weight_decay": 0.01}
        )

    def test_adam_custom_eps(self):
        """Test Adam with custom epsilon."""
        run_optimizer_parity_test(self, optim.Adam, torch_optim.Adam, {"lr": 0.001, "eps": 1e-6})
...
class TestAdamWParity(TestCase):
    ...
    def test_adamw_basic(self):
        """Test basic AdamW."""
        run_optimizer_parity_test(self, optim.AdamW, torch_optim.AdamW, {"lr": 0.001})

    def test_adamw_weight_decay(self):
        """Test AdamW with weight decay."""
        run_optimizer_parity_test(
            self, optim.AdamW, torch_optim.AdamW, {"lr": 0.001, "weight_decay": 0.01}
        )

    def test_adamw_amsgrad(self):
        """Test AdamW with AMSGrad."""
        run_optimizer_parity_test(
            self, optim.AdamW, torch_optim.AdamW, {"lr": 0.001, "amsgrad": True}
        )

    def test_adamw_custom_betas(self):
        """Test AdamW with custom betas."""
        run_optimizer_parity_test(
            self, optim.AdamW, torch_optim.AdamW, {"lr": 0.001, "betas": (0.85, 0.995)}
        )
...
class TestRMSpropParity(TestCase):
    ...
    def test_rmsprop_basic(self):
        """Test basic RMSprop."""
        run_optimizer_parity_test(self, optim.RMSprop, torch_optim.RMSprop, {"lr": 0.01})

    def test_rmsprop_momentum(self):
        """Test RMSprop with momentum."""
        run_optimizer_parity_test(
            self, optim.RMSprop, torch_optim.RMSprop, {"lr": 0.01, "momentum": 0.9}
        )

    def test_rmsprop_centered(self):
        """Test RMSprop with centered gradient."""
        run_optimizer_parity_test(
            self, optim.RMSprop, torch_optim.RMSprop, {"lr": 0.01, "centered": True}
        )

    def test_rmsprop_weight_decay(self):
        """Test RMSprop with weight decay."""
        run_optimizer_parity_test(
            self, optim.RMSprop, torch_optim.RMSprop, {"lr": 0.01, "weight_decay": 0.01}
        )

    def test_rmsprop_custom_alpha(self):
        """Test RMSprop with custom alpha."""
        run_optimizer_parity_test(
            self, optim.RMSprop, torch_optim.RMSprop, {"lr": 0.01, "alpha": 0.95}
        )
...
class TestAdagradParity(TestCase):
    ...
    def test_adagrad_basic(self):
        """Test basic Adagrad."""
        run_optimizer_parity_test(self, optim.Adagrad, torch_optim.Adagrad, {"lr": 0.01})

    def test_adagrad_lr_decay(self):
        """Test Adagrad with learning rate decay."""
        run_optimizer_parity_test(
            self, optim.Adagrad, torch_optim.Adagrad, {"lr": 0.01, "lr_decay": 0.01}
        )

    def test_adagrad_weight_decay(self):
        """Test Adagrad with weight decay."""
        run_optimizer_parity_test(
            self, optim.Adagrad, torch_optim.Adagrad, {"lr": 0.01, "weight_decay": 0.01}
        )

    def test_adagrad_initial_accumulator(self):
        """Test Adagrad with initial accumulator value."""
        run_optimizer_parity_test(
            self, optim.Adagrad, torch_optim.Adagrad, {"lr": 0.01, "initial_accumulator_value": 0.1}
        )
...
class TestAdadeltaParity(TestCase):
    ...
    def test_adadelta_basic(self):
        """Test basic Adadelta."""
        run_optimizer_parity_test(self, optim.Adadelta, torch_optim.Adadelta, {"lr": 1.0})

    def test_adadelta_custom_rho(self):
        """Test Adadelta with custom rho."""
        run_optimizer_parity_test(
            self, optim.Adadelta, torch_optim.Adadelta, {"lr": 1.0, "rho": 0.95}
        )

    def test_adadelta_weight_decay(self):
        """Test Adadelta with weight decay."""
        run_optimizer_parity_test(
            self, optim.Adadelta, torch_optim.Adadelta, {"lr": 1.0, "weight_decay": 0.01}
        )
...
class TestAdamaxParity(TestCase):
    ...
    def test_adamax_basic(self):
        """Test basic Adamax."""
        run_optimizer_parity_test(self, optim.Adamax, torch_optim.Adamax, {"lr": 0.002})

    def test_adamax_weight_decay(self):
        """Test Adamax with weight decay."""
        run_optimizer_parity_test(
            self, optim.Adamax, torch_optim.Adamax, {"lr": 0.002, "weight_decay": 0.01}
        )

    def test_adamax_custom_betas(self):
        """Test Adamax with custom betas."""
        run_optimizer_parity_test(
            self, optim.Adamax, torch_optim.Adamax, {"lr": 0.002, "betas": (0.85, 0.995)}
        )
...
class TestRAdamParity(TestCase):
    ...
    def test_radam_basic(self):
        """Test basic RAdam."""
        run_optimizer_parity_test(self, optim.RAdam, torch_optim.RAdam, {"lr": 0.001})

    def test_radam_weight_decay(self):
        """Test RAdam with weight decay."""
        run_optimizer_parity_test(
            self, optim.RAdam, torch_optim.RAdam, {"lr": 0.001, "weight_decay": 0.01}
        )

    def test_radam_custom_betas(self):
        """Test RAdam with custom betas."""
        run_optimizer_parity_test(
            self, optim.RAdam, torch_optim.RAdam, {"lr": 0.001, "betas": (0.85, 0.995)}
        )
...
class TestNAdamParity(TestCase):
    ...
    def test_nadam_basic(self):
        """Test basic NAdam."""
        run_optimizer_parity_test(self, optim.NAdam, torch_optim.NAdam, {"lr": 0.002})

    def test_nadam_weight_decay(self):
        """Test NAdam with weight decay."""
        run_optimizer_parity_test(
            self, optim.NAdam, torch_optim.NAdam, {"lr": 0.002, "weight_decay": 0.01}
        )
...
class TestASGDParity(TestCase):
    ...
    def test_asgd_basic(self):
        ...
        run_optimizer_parity_test(
            self, optim.ASGD, torch_optim.ASGD, {"lr": 0.01}, rtol=1e-4, atol=1e-5
        )
...
class TestRpropParity(TestCase):
    ...
    def test_rprop_basic(self):
        """Test basic Rprop."""
        run_optimizer_parity_test(self, optim.Rprop, torch_optim.Rprop, {"lr": 0.01})

    def test_rprop_custom_etas(self):
        """Test Rprop with custom etas."""
        run_optimizer_parity_test(
            self, optim.Rprop, torch_optim.Rprop, {"lr": 0.01, "etas": (0.4, 1.3)}
        )

    def test_rprop_custom_step_sizes(self):
        """Test Rprop with custom step sizes."""
        run_optimizer_parity_test(
            self, optim.Rprop, torch_optim.Rprop, {"lr": 0.01, "step_sizes": (1e-7, 40)}
        )
...
class TestMultiStepParity(TestCase):
    ...
    def test_adam_100_steps(self):
        ...
        run_optimizer_parity_test(self, optim.Adam, torch_optim.Adam, {"lr": 0.001}, num_steps=100)

    def test_sgd_momentum_100_steps(self):
        """Test SGD with momentum over 100 steps."""
        run_optimizer_parity_test(
            self, optim.SGD, torch_optim.SGD, {"lr": 0.01, "momentum": 0.9}, num_steps=100
        )

    def test_adamw_100_steps(self):
        """Test AdamW over 100 steps."""
        run_optimizer_parity_test(
            self, optim.AdamW, torch_optim.AdamW, {"lr": 0.001, "weight_decay": 0.01}, num_steps=100
        )
...
class TestLargerTensorsParity(TestCase):
    ...
    def test_adam_large_tensor(self):
        ...
        run_optimizer_parity_test(
            self, optim.Adam, torch_optim.Adam, {"lr": 0.001}, param_shape=(1000, 100), num_steps=20
        )
