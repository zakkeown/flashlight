...
class TestReLU(TestCase):
    ...
    def test_relu_requires_grad(self):
        ...
        x = flashlight.tensor([1.0, -1.0], requires_grad=True)
        y = flashlight.relu(x)
...
class TestSigmoid(TestCase):
    ...
    def test_sigmoid_range(self):
        ...
        x = flashlight.tensor([-10.0, -1.0, 0.0, 1.0, 10.0])
        y = flashlight.sigmoid(x)
        y_np = y.numpy()
        self.assertTrue((y_np > 0).all())
    ...
    def test_sigmoid_symmetry(self):
        ...
        x = flashlight.tensor([1.0, 2.0, 3.0])
        y_pos = flashlight.sigmoid(x)
        y_neg = flashlight.sigmoid(-x)
...
class TestTanh(TestCase):
    ...
    def test_tanh_range(self):
        ...
        x_small = flashlight.tensor([-1.0, 0.0, 1.0])
        y_small = flashlight.tanh(x_small)
    ...
    def test_tanh_antisymmetry(self):
        ...
        x = flashlight.tensor([1.0, 2.0, 3.0])
        y_pos = flashlight.tanh(x)
        y_neg = flashlight.tanh(-x)
...
class TestLogSoftmax(TestCase):
    ...
    def test_log_softmax_consistency(self):
        ...
        x = flashlight.tensor([1.0, 2.0, 3.0, 4.0])
        y_log_softmax = flashlight.log_softmax(x)
        y_softmax = flashlight.softmax(x)
        y_log = flashlight.log(y_softmax)
...
class TestSiLU(TestCase):
    ...
    def test_silu_swish_alias(self):
        ...
        x = flashlight.tensor([1.0, 2.0, 3.0])
        y_silu = flashlight.silu(x)
        y_swish = flashlight.swish(x)
...
class TestLeakyReLU(TestCase):
    ...
    def test_leaky_relu_custom_slope(self):
        ...
        y = flashlight.leaky_relu(x, negative_slope=0.2)
...
class TestELU(TestCase):
    ...
    def test_elu_range(self):
        ...
        x = flashlight.tensor([-1.0, -2.0, -5.0])
        y = flashlight.elu(x, alpha=1.0)
        y_np = y.numpy()
