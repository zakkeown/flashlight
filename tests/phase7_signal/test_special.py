"""
Comprehensive tests for flashlight.special module.
...
class TestIncompleteGamma:
    ...
    def test_gammainc_gammaincc_sum(self):
        ...
        a = flashlight.tensor([1.0, 2.0, 3.0, 5.0])
        x = flashlight.tensor([0.5, 1.0, 2.0, 3.0])
        inc = flashlight.special.gammainc(a, x)
        incc = flashlight.special.gammaincc(a, x)
...
class TestBesselFunctions:
    ...
    def test_bessel_y1(self):
        ...
        x = flashlight.tensor([0.5, 1.0, 2.0, 5.0, 10.0])
        result = flashlight.special.bessel_y1(x)
...
class TestChebyshevPolynomials:
    ...
    def test_chebyshev_t(self):
        ...
        x = flashlight.tensor([-1.0, -0.5, 0.0, 0.5, 1.0])
...
class TestLaguerrePolynomials:
    ...
    def test_laguerre_l(self):
        ...
        x = flashlight.tensor([0.0, 1.0, 2.0, 3.0])
...
class TestSphericalBessel:
    ...
    def test_spherical_bessel_j0(self):
        ...
        x = flashlight.tensor([0.1, 1.0, 2.0, 5.0])
...
class TestSimpleFunctions:
    ...
    def test_xlog1py(self):
        ...
        x = flashlight.tensor([0.0, 1.0, 2.0])
...
class TestEdgeCases:
    ...
    def test_ndtr_extremes(self):
        ...
        result_neg = flashlight.special.ndtr(flashlight.tensor([-6.0]))
        result_pos = flashlight.special.ndtr(flashlight.tensor([6.0]))
