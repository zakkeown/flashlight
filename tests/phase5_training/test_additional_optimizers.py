...
class TestRMSprop(TestCase):
    ...
    def test_rmsprop_step(self):
        ...
        optimizer = mlx_compat.optim.RMSprop([param], lr=0.1)
    ...
    def test_rmsprop_with_momentum(self):
        ...
        param = mlx_compat.nn.Parameter(mlx_compat.tensor([1.0, 2.0, 3.0]))
        optimizer = mlx_compat.optim.RMSprop([param], lr=0.1, momentum=0.9)
    ...
    def test_rmsprop_centered(self):
        ...
        param = mlx_compat.nn.Parameter(mlx_compat.tensor([1.0, 2.0, 3.0]))
        optimizer = mlx_compat.optim.RMSprop([param], lr=0.1, centered=True)
    ...
    def test_rmsprop_weight_decay(self):
        ...
        param = mlx_compat.nn.Parameter(mlx_compat.tensor([1.0, 2.0, 3.0]))
        optimizer = mlx_compat.optim.RMSprop([param], lr=0.1, weight_decay=0.01)
...
class TestAdadelta(TestCase):
    ...
    def test_adadelta_weight_decay(self):
        ...
        param = mlx_compat.nn.Parameter(mlx_compat.tensor([1.0, 2.0, 3.0]))
        optimizer = mlx_compat.optim.Adadelta([param], weight_decay=0.01)
...
class TestAdagrad(TestCase):
    ...
    def test_adagrad_creation(self):
        ...
        param = mlx_compat.nn.Parameter(mlx_compat.randn(3, 3))
        optimizer = mlx_compat.optim.Adagrad([param])
        self.assertIsNotNone(optimizer)

    def test_adagrad_creation_with_lr(self):
        """Test Adagrad creation with custom learning rate."""
        param = mlx_compat.nn.Parameter(mlx_compat.randn(3, 3))
        optimizer = mlx_compat.optim.Adagrad([param], lr=0.1)
    ...
    def test_adagrad_lr_decay(self):
        ...
        param = mlx_compat.nn.Parameter(mlx_compat.tensor([1.0, 2.0, 3.0]))
        optimizer = mlx_compat.optim.Adagrad([param], lr=0.1, lr_decay=0.01)
    ...
    def test_adagrad_weight_decay(self):
        ...
        param = mlx_compat.nn.Parameter(mlx_compat.tensor([1.0, 2.0, 3.0]))
        optimizer = mlx_compat.optim.Adagrad([param], weight_decay=0.01)
