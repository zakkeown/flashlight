...
class Embedding(Module):
    ...
    Example:
        ...
        >>> input = flashlight.tensor([1, 2, 4, 5])
        ...
        >>> input = flashlight.tensor([[0, 2, 0, 5]])
        >>> output = embedding(input)
        >>> output.shape
        (1, 4, 3)
    """
    ...
    def from_pretrained(
        ...
        Example:
            >>> pretrained = flashlight.randn(1000, 300)  # 1000 words, 300-dim
...
class EmbeddingBag(Module):
    ...
    Example:
        ...
        >>> input = flashlight.tensor([1, 2, 4, 5, 4, 3, 2, 9])
        >>> offsets = flashlight.tensor([0, 4])  # 2 bags: [1,2,4,5] and [4,3,2,9]
