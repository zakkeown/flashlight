...
def scaled_dot_product_attention(
    ...
    Example:
        >>> q = flashlight.randn(2, 8, 10, 64)  # (batch, heads, seq, head_dim)
        >>> k = flashlight.randn(2, 8, 10, 64)
        >>> v = flashlight.randn(2, 8, 10, 64)
...
class MultiheadAttention(Module):
    ...
    Example:
        ...
        >>> query = flashlight.randn(32, 10, 512)  # (batch, seq, embed)
        >>> key = flashlight.randn(32, 20, 512)
        >>> value = flashlight.randn(32, 20, 512)
