...
_DEFAULT_CACHE_DIR = os.path.join(os.path.expanduser("~"), ".cache", "flashlight", "hub")
...
def get_dir() -> str:
    ...
    if ENV_XDG_CACHE_HOME in os.environ:
        return os.path.join(os.environ[ENV_XDG_CACHE_HOME], "flashlight", "hub")
...
def _download_url_to_file(
    ...
    req = Request(url, headers={"User-Agent": "flashlight"})
...
def load_url(
    ...
    # Load the checkpoint
    return flashlight.load(cached_file, weights_only=weights_only)
