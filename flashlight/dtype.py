...
def get_dtype(dtype) -> Optional[DType]:
    """
    Convert various dtype representations to flashlight.DType.
    ...
    Returns:
        Corresponding flashlight.DType or None
    """
    if dtype is None:
        return float32
    ...
    raise ValueError(f"Cannot convert {dtype} to flashlight dtype")
...
def torch_dtype_to_numpy(dtype):
    """
    Convert a torch/flashlight dtype to numpy dtype.
